    ...
    <header className="sticky top-0 z-40 w-full border-b border-slate-200/80 bg-white/95 backdrop-blur-md transition-all">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-7 lg:gap-9 text-sm font-medium text-slate-600">
          <a href="#workflows" className="hover:text-brand-900 transition-colors">
            Workflows
          </a>
        ...
        <div className="flex items-center gap-2.5 sm:gap-3">
          <a
            href="/login"
            className="inline-flex items-center gap-1.5 px-3.5 py-2 sm:px-4 sm:py-2.5 rounded-lg bg-slate-100 hover:bg-slate-200/80 text-slate-800 font-semibold text-xs sm:text-sm transition-all border border-slate-200 shadow-xs"
          >
            <MonitorPlay className="w-4 h-4 text-brand-700 shrink-0" />
            <span>Live Demo</span>
          </a>
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-3.5 py-2 sm:px-5 sm:py-2.5 rounded-lg bg-emerald-600 hover:bg-emerald-700 active:bg-emerald-800 text-white font-semibold text-xs sm:text-sm transition-all duration-150 shadow-xs hover:shadow-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2"
          >
