...
export default function Features() {
  ...
  return (
    <section id="features" className="py-8 sm:py-12 md:py-14 bg-white border-b border-slate-200/80">
              ...
              >
                <div>
                  <div className="flex items-center justify-between mb-3">
                    <div className={`w-9 h-9 rounded-lg flex items-center justify-center ${feat.iconBg}`}>
                  ...
                  <h3 className="text-base sm:text-lg font-bold text-navy-900 mb-1.5">{feat.title}</h3>
                  <p className="text-xs sm:text-sm text-slate-600 leading-relaxed mb-4">{feat.desc}</p>
                </div>
